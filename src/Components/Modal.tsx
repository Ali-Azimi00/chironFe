        ...
        <React.Fragment>
            ...
            >
                <div className="mx-auto  p-4 w-full xxsm:w-128 md:w-128 max-w-2xl max-h-full min-w-[400px]">
                    <div className="relative  bg-white rounded-lg shadow bg-secondary modal">
                        <div className="flex items-center justify-between p-4 pt-6 pb-0 rounded-t">
                          
                            <h3 className="modalText text-xl font-semibold hover:tracking-wide text-gray-900 dark:text-white">
